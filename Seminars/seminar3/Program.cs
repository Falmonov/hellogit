...
// void FindDiapazon(int NumQuadro)
// {

//     if (NumQuadro < 1 && NumQuadro > 4) { Console.WriteLine("Wrong input number"); }

//     if (NumQuadro == 1) { Console.WriteLine("X>0, Y>0"); }

//     if (NumQuadro == 2) { Console.WriteLine("X<0, Y>0"); }

//     if (NumQuadro == 3) { Console.WriteLine("X<0, Y<0"); }

//     if (NumQuadro == 4) { Console.WriteLine("X>0, Y<0"); }

// }

// Console.WriteLine("Input number of quadro");
// int x = Convert.ToInt32(Console.ReadLine());
// Console.WriteLine($"Диапазон координат в {x} четверти:");
// FindDiapazon(x);
